...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/drbh/nftli/releases/download/v0.0.0/nftli_v0.0.0_x86_64-apple-darwin.zip"
		FTYPE=".zip"
		;;
	"linux_386")
		URL="https://github.com/drbh/nftli/releases/download/v0.0.0/nftli_v0.0.0_x86_64-unknown-linux-musl.tar.gz"
		FTYPE=".gz"
		;;
